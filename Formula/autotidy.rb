...
class Autotidy < Formula
  ...
  on_macos do
    on_intel do
      url "file:///Users/bryce/projects/autotidy/autotidy_#{version}_darwin_amd64.tar.gz"
      sha256 "5880c8b551fb0f87d63fc40551a691ff6cedbfad1a12334922505425f7d82476"
    end

    on_arm do
      url "file:///Users/bryce/projects/autotidy/autotidy_#{version}_darwin_arm64.tar.gz"
